...
methods to calculate area and perimeter, print the rectangle with '#',
repr() for eval(), deletion message, and a class attribute
number_of_instances to track the number of active Rectangle instances.
"""

class Rectangle:
    """Rectangle class with width, height, area, perimeter, string representation,
    eval()-friendly repr(), deletion message, and instance counting.
    """
