...
stored in print_symbol, repr() for eval(), deletion message, instance counting,
...
class Rectangle:
    ...
    eval()-friendly repr(), deletion message, instance counting, customizable
    print symbol, static method bigger_or_equal, and class method square.
    """
